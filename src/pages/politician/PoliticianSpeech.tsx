      ...
      {step === 1 && (
        <div>
          ...
          <div className="pol-field-group">
            ...
            <input value={form.audience} onChange={(e) => setForm((f) => ({ ...f, audience: e.target.value }))} placeholder="e.g. Indiana State House floor, District 12 town hall" />
          </div>
          <div className="pol-field-group">
      ...
      {step === 3 && (
        <div>
          ...
          <div style={{ padding: '10px 14px', borderRadius: 10, background: 'rgba(107,93,230,0.08)', border: '1px solid var(--navy-border)', fontSize: '0.8rem', color: 'var(--muted)', marginBottom: 16 }}>
            <strong>Compliance reminder:</strong> Include "Paid for by Johnson for State House. Sandra K. Moore, Treasurer." at the end of all public-facing speech documents.
          </div>
            ...
            <div style={{ minWidth: 0 }}>
              {view === 'edit' && selectedSpeech ? (
                ...
                <div className="pol-card" style={{ display: 'grid', placeItems: 'center', minHeight: 300, color: 'var(--muted)', textAlign: 'center' }}>
                  <div>
                    <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" style={{ color: 'var(--border-strong)', marginBottom: 12 }}><path d="M12 1a3 3 0 0 0-3 3v8a3 3 0 0 0 6 0V4a3 3 0 0 0-3-3z"/><path d="M19 10v2a7 7 0 0 1-14 0v-2"/><line x1="12" y1="19" x2="12" y2="23"/><line x1="8" y1="23" x2="16" y2="23"/></svg>
