      ...
      const fallbackVariants: AdVariant[] = [
        {
          ...
          body: `Marcus Johnson has delivered real results for our community. ${form.keyMessage || 'Support his campaign today and help us finish what we started.'}`,
        ...
        },
        {
          ...
          body: `Healthcare. Schools. Affordable housing. Marcus Johnson has fought for every one of these issues — and needs your support to keep going.`,
        ...
        },
        {
          ...
          body: `The work isn't done in District 12. Marcus Johnson is counting on you. ${form.goal === 'Fundraising' ? 'Every dollar makes a difference before the deadline.' : 'Every vote matters on Election Day.'}`,
