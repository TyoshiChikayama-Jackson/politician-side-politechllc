...
export const demoContributions: Contribution[] = [
  ...
  },
  {
    ...
    refundStatus: 'none',
    prohibitedSourceAcknowledged: true,
    auditLog: [{ timestamp: '2024-04-18T18:00:00Z', user: 'Marcus Johnson', action: 'created', details: 'In-kind catering contribution recorded' }],
  },
  {
    id: 'con-005',
    donorId: 'don-002',
...
export const demoExpenses: Expense[] = [
  { id: 'exp-001', vendor: 'Indy Digital Media', amount: 4200, category: 'Advertising', date: '2024-03-01', paymentMethod: 'card', approvalStatus: 'approved', approvedBy: 'Marcus Johnson', memo: 'Digital ad campaign - March push' },
  { id: 'exp-002', vendor: 'Campaign Staff - Payroll', amount: 6500, category: 'Staff', date: '2024-04-01', paymentMethod: 'wire', approvalStatus: 'approved', approvedBy: 'Marcus Johnson', memo: 'April payroll - 2 FTE campaign staff' },
  ...
  { id: 'exp-004', vendor: 'United Airlines', amount: 620, category: 'Travel', date: '2024-04-10', paymentMethod: 'card', approvalStatus: 'approved', approvedBy: 'Marcus Johnson', memo: 'Trip to DC for policy conference' },
  { id: 'exp-005', vendor: 'Crowne Plaza Indianapolis', amount: 2400, category: 'Events', date: '2024-04-18', paymentMethod: 'card', approvalStatus: 'approved', approvedBy: 'Marcus Johnson', memo: 'Spring fundraiser venue rental' },
  ...
  { id: 'exp-008', vendor: 'Capitol Strategic Consulting', amount: 3500, category: 'Consulting', date: '2024-02-28', paymentMethod: 'check', approvalStatus: 'approved', approvedBy: 'Marcus Johnson', memo: 'Political strategy consulting - Q1' },
...
export const demoAds: AdCampaign[] = [
  {
    ...
    keyMessage: 'Marcus Johnson is fighting for District 12 — support his campaign today',
    tone: 'Hopeful',
    status: 'active',
    createdAt: '2024-04-01',
    budget: 1500,
    ...
    variants: [
      {
        ...
        body: 'Marcus Johnson has delivered for our community — affordable housing, better schools, and healthcare access. Help him keep fighting. Every dollar counts.',
        cta: 'Donate Now',
        charCount: 180,
      },
      {
      ...
      },
      {
        ...
        body: 'The work isn\'t done. Marcus Johnson is in a tight race — and every contribution before June 30 is matched. Give today.',
  ...
  },
  {
    ...
    platform: 'Google',
    goal: 'Voter Outreach',
    targetAudience: 'Marion County registered voters searching for Marcus Johnson or District 12',
    ...
    variants: [
      {
        ...
        headline: 'Marcus Johnson — Indiana House D-12',
      ...
      },
      {
        ...
        body: 'Representative Marcus Johnson is your voice at the Statehouse. See his record, read his positions, and get involved.',
        cta: 'Learn More',
        charCount: 155,
      },
      {
        ...
        headline: 'Vote Marcus Johnson — Nov 3',
        body: 'Re-elect Marcus Johnson to the Indiana State House. Proven results, District 12 first.',
        cta: 'Get Involved',
        charCount: 131,
      },
    ],
    ...
    variants: [
      {
        ...
        body: 'November 3rd. Polls open 6am–6pm. Marcus Johnson is on the ballot and fighting for YOU. Tag a friend who needs to vote.',
        cta: 'Register Now',
        charCount: 152,
      },
      {
        ...
        body: 'These issues are on the ballot. Marcus Johnson has a plan — but only if we show up. November 3rd. Every vote counts.',
      ...
      },
      {
        ...
        body: 'Early voting is open. Join your neighbors who are making their voice heard. Vote Marcus Johnson for State House D-12.',
        cta: 'Vote Early',
        charCount: 163,
      },
    ],
